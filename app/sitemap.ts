...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/blog/how-to-calculate-mortgage-payment`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.80 },
    { url: `${BASE_URL}/blog/30-year-vs-15-year-mortgage`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.80 },
    { url: `${BASE_URL}/blog/what-is-pmi-and-how-to-avoid-it`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.80 },
    { url: `${BASE_URL}/blog/biweekly-vs-monthly-mortgage-payments`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.78 },
    { url: `${BASE_URL}/blog/how-much-house-can-you-afford`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.78 },
    { url: `${BASE_URL}/blog/first-time-home-buyer-mortgage-guide-2026`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.78 },
    { url: `${BASE_URL}/faq`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${BASE_URL}/about`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.65 },
    { url: `${BASE_URL}/contact`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.55 },
